...
def critique_and_improve(draft: dict) -> str:
    critique_prompt = f"""You are a senior .NET developer relations editor reviewing an article draft.
...
1. Does the opening sentence name a specific real .NET developer pain point? (not "Claude Code lets you...")
2. Is the C# or .NET code example complete and compile-ready — real namespaces, real APIs, not stubs?
...
5. Would a senior .NET developer learn something they couldn't get from reading the docs?
